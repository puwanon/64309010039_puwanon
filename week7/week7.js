...
for (let i = 0; i < Employee.length; i++) {
    ...
    console.log(Employee[i].name,
        ...
        "เงินเดือน", Employee[i].salary,"บาท",
        "โบนัส", Math.ceil(Employee[i].Bonus),"บาท",
        "รายได้สุทธิต่อปี", Employee[i].ni,"บาท",
        "ภาษีที่ต้องจ่าย", Employee[i].tax,"บาท"
    )
}
...
for (i = 0; i < Employee.length; i++) {
    if (Employee[i].department == "ไอที") {
        console.log(Employee[i].name,"ภาษีที่ต้องจ่าย", Employee[i].tax," บาท")
    }
}
